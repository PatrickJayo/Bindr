...
<?php
$mYiD = $_SESSION['id'];
$getS_sql = "SELECT * FROM matches WHERE p_id =:mYiD ORDER BY id DESC LIMIT 5";
...
?>
<a href="./u/<?php echo $_SESSION['Username']; ?>&ut=matches"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f49f.png" /> <?php echo lang('see_all_matches'); ?></p></a>
