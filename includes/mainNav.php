...
if (is_dir("imgs/")) {
    ...
    $directoryPath = "../";
}elseif (is_dir("<?php echo $directoryPath; ?>imgs/")) {
    $directoryPath = "<?php echo $directoryPath; ?>";
}
// ================================ check user exist ===================================
session_start();
...
<nav class="navbar navbar-inverse" style="position:fixed;top:0;right:0;left:0;z-index: 2;">
    <div class="container-fluid" style="width: 1040px;">
        <div class="navbar-header" style="float: <?php echo lang('float'); ?>;">
            ...
            <a class="logo" href="<?php echo $directoryPath; ?>home"><strong>B I N D R</strong></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="<?php echo lang('ul_navbar_nav1'); ?>">
                ...
                <div id="notifications_rP" class="scrollbar" style="max-height: 450px; overflow-y: scroll;">
                    <div id="notifications_r" data-load="0">
                        ...
                        <p style='width: 100%;border:none;display: none' id="notifications_loading" align='center'><img src='<?php echo $directoryPath; ?>imgs/loading_video.gif' style='width:20px;box-shadow: none;height: 20px;'></p>
                ...
                <a href='<?php echo $directoryPath; ?>notifications'>
                ...
                <li><a href="<?php echo $directoryPath; ?>messages/" style="padding: 16px 10px;"><span class="fa fa-envelope"></span> <?php echo lang('messages'); ?> <span id="messagesCount"></span></a>
                </li>
            </ul>
            <ul class="<?php echo lang('ul_navbar_nav2'); ?>">
                ...
                <li class="dropdown"><a href="<?php echo $directoryPath; ?>u/<?php echo $_SESSION['Username']; ?>" style="padding-bottom: 0px;padding-top: 9px;" class="dropdown-toggle" data-toggle="dropdown">
                        <div style="width: 36px;height: 36px;border-radius: 100%;overflow: hidden;background: #fff;">
                            <img style="width: auto;height: 100%;" src="<?php echo $directoryPath.'imgs/user_imgs/'.$_SESSION['Userphoto']; ?>">
                        </div></a>
                    <ul class="dropdown-menu" style="margin-top: 8px;text-align: <?php echo lang('textAlign');?>">
                     <li class='dropdown-header'><?php echo lang('navbar_uMenu_UserProfile'); ?></li>
                        <li><a href="<?php echo $directoryPath; ?>u/<?php echo $_SESSION['Username']; ?>">
                        ...
                        <li><a href=\"".$directoryPath."toacpnlp/?adb=General\"> ".lang('dashboard')."</a></li>
                            ";
                        }
                        ?>
                        <li class="divider"></li>
                        <li><a href="<?php echo $directoryPath; ?>settings"> <?php echo lang('settings'); ?></a></li>
                        ...
                        <li><a href="<?php echo $directoryPath; ?>page/supportbox"> <?php echo lang('supportBox'); ?></a></li>
                        <li><a href="<?php echo $directoryPath; ?>page/report"> <?php echo lang('Report_A_Problem'); ?></a></li>
                        <li><a href="<?php echo $directoryPath; ?>logout"> <?php echo lang('logout'); ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<?php include ($directoryPath."js/navbar_nottifi_js.php"); ?>