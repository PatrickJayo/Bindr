...
<div class="dashboard_box" style="text-align: <? echo lang('textAlign'); ?>">
   ...
   <?php
        ...
        switch ($r_type) {
            ...
            break;
            case 'post':
                $report = "<a href='".$directoryPath."posts/post?pid=$for_id'>".lang('report_about_post')."</a>";
            break;
        }
            ...
            <tr>
                <td>
                    <div style="width: 32px;height: 32px;overflow: hidden;border-radius: 20px;border:1px solid #ccc;">
                        <img style="width: auto;height: 100%;" src="<? echo $directoryPath; ?>imgs/user_imgs/<? echo $fromid_ph; ?>" />
                    </div>
                </td>
