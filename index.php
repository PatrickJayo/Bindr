...
<head>
    <title><? echo lang('welcome'); ?> | Bindr</title>
    <meta charset="UTF-8">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">Bindr</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> Bindr</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('Bindr_main_string'); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/heart_message.png" alt="Bindr" style="width: 300px;" />
                </div>
            </div>
        </div>
