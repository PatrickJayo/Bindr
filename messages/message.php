...
<head>
    <title><? echo lang('messages'); ?> | Bindr</title>
    <meta charset="UTF-8">
    	...
    	<div class="messages">
    		...
    		<div id="m_contacts" class="scrollbar" style="position: absolute; top: 0; right: 0; left: 0; bottom: 0; margin-top: 50px; overflow: auto;">
                ...
                <div id="m_contacts_requests">
                    <div style="text-align: center; padding: 15px;"><img src="<? echo $directoryPath; ?>imgs/loading_video.gif"></div>
                </div>
                <br>
			...
			<div id="m_userTyping" class="m_msgU1" style="display:none;margin: 8px;margin-bottom: 15px;"><img src="<? echo $directoryPath; ?>/imgs/typing.gif" style=" width: 30px; "></div>
			<div id="m_messages_loading" style='display:none;text-align: center; padding: 15px;'><img src='<? echo $directoryPath; ?>imgs/loading_video.gif'></div>
    		</div>
