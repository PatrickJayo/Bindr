...
var sbar = $(this).val();
var directoryPath = "<?php echo $directoryPath; ?>";
if(sbar == ''){
...
$.ajax({
type: "POST",
url: "<?php echo $directoryPath; ?>includes/searchq.php",
data: {'search_user':sbar,'directoryPath':directoryPath},
cache: false,
beforeSend:function(){
...
var path = "<?php echo $directoryPath; ?>";
var whatF = "fetch";
var load = $('#'+obj+'_load').val();
$.ajax({
type: "POST",
url: "<?php echo $directoryPath; ?>includes/fetch_notifybox.php",
...
$.ajax({
    type:'POST',
    url:"<?php echo $directoryPath; ?>includes/m_requests.php",
